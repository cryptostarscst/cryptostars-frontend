...
import iosBtn from "./assets/images/ios-download.png";

import { Routes, Route } from "react-router-dom";
import TournamentTypes from "./TournamentTypes";
import TournamentRoom from "./TournamentRoom"; // ✅ ADICIONADO
                ...
                <>
                  ...
                  <div className="neon-banner">
                    <marquee behavior="scroll" direction="left">
                      REGISTER AND RECEIVE <strong>1 USDC</strong> +{" "}
                      <strong>10.000 CST</strong> TO PLAY AND EXPLORE THE CRYPTOSTARS
                      COMPETITIVE WORLD!
                    </marquee>
                  </div>
                  ...
                  <section className="page-section" style={{ position: "relative", overflow: "hidden" }}>
                    ...
                    <div
                      ...
                      onMouseEnter={() =>
                        document.querySelector(".roadmap-buttons")?.classList.add("show")
                      }
                      onMouseLeave={() =>
                        document.querySelector(".roadmap-buttons")?.classList.remove("show")
                      }
                    >
                      ...
                      <div className="roadmap-buttons">
                        <button className="roadmap-btn" onClick={() => setShowBetaModal(true)}>
                          Beta Launch
                        </button>

                        <button className="roadmap-btn" onClick={() => setShowStakingModal(true)}>
                          Staking
                        </button>

                        <button className="roadmap-btn" onClick={() => setShowRankingInfo(true)}>
                          Ranking
                        </button>

                        <button className="roadmap-btn" onClick={() => setShowReferralInfo(true)}>
                          Affiliates
                        </button>

                        <button className="roadmap-btn" onClick={() => setShowCSTModal(true)}>
                          CST Token
                        </button>
                      </div>
                    </div>
                  ...
                  {/* Modais (iguais ao seu) */}
                  {showBetaModal && (
                    <div className="chart-overlay">
                      <div className="chart-card store-modal-card">
                        <h2>Welcome to CryptoStars – The New Era of Trading Tournaments</h2>
                        <p>
                          CryptoStars is the <strong>first competitive trading tournament platform</strong>{" "}
                          in the world, focused on real performance, instant rewards, and intelligent
                          gamification.
                        </p>
                        ...
                        <ul>
                          <li>
                            <strong>Hyper Turbo & Regular Tournaments:</strong> 10-minute sessions
                            where traders compete in real time using live charts and markets, allowing
                            them to multiply their registration value countless times over without
                            relying on major market movements — only skill and strategy matter.
                          </li>
                          <li>
                            <strong>Rewards in USDC and CST Token:</strong> Earn <strong>CST</strong>{" "}
                            and <strong>USDC</strong> based on your performance. Use it to participate,
                            grow or withdraw.
                          </li>
                          <li>
                            <strong>Smart Referral System:</strong> Invite friends and earn bonuses in{" "}
                            <strong>USDC</strong> and <strong>CST</strong>. Just one invite gives you
                            resources to play and grow your profile.
                          </li>
                          <li>
                            <strong>Exclusive Bonuses:</strong> The first 1,000 players receive{" "}
                            <strong>1 USDC + 10,000 CST</strong> at registration to play without
                            investing a cent.
                          </li>
                          <li>
                            <strong>Ranking by Merit, not Luck:</strong> No raffles or pay-to-win. Pure
                            skill-based competition.
                          </li>
                          <li>
                            <strong>Blockchain Transparency:</strong> All actions and rewards are
                            recorded and traceable — real merit, real recognition.
                          </li>
                        </ul>

                        <p>
                          <strong>CryptoStars is more than a game — it’s a competitive battlefield for real traders.</strong>
                        </p>
                        <p><strong>Get ready. Compete. Earn.</strong></p>

                        <button className="close-chart-button" onClick={() => setShowBetaModal(false)}>
                          Close
                        </button>
                      </div>
                    </div>
                  ...
                  {showStakingModal && (
                    <div className="chart-overlay">
                      <div className="chart-card store-modal-card">
                        ...
                        <ul>
                          <li>
                            <strong>Real Profit Sharing:</strong> 1.5% of all tournament entry fees are
                            collected daily and added to the staking pool.
                          </li>
                          <li>
                            <strong>Daily Payouts:</strong> Every 24 hours, the platform distributes
                            100% of the staking pool proportionally to all CST holders with tokens in
                            staking.
                          </li>
                          <li>
                            <strong>Based on Amount Staked:</strong> The more CST tokens you stake, the
                            bigger your share of daily profits.
                          </li>
                          <li>
                            <strong>No Lock-in Period:</strong> You can add or remove your tokens
                            anytime with full flexibility.
                          </li>
                        </ul>

                        <p>
                          <strong>CryptoStars staking rewards you for believing in the ecosystem.</strong>
                          <br />
                          As the number of users and tournaments grows, so do your daily earnings —
                          because the profit is real.
                        </p>

                        <p><strong>Stake CST. Share the success. Earn passively.</strong></p>

                        <button className="close-chart-button" onClick={() => setShowStakingModal(false)}>
                          Close
                        </button>
                      </div>
                    </div>
                  ...
                  {showRankingInfo && (
                    <div className="chart-overlay">
                      <div className="chart-card">
                        ...
                        <p>
                          The CryptoStars platform rewards the <strong>top 10% of ranked players</strong>{" "}
                          every week with real USDC.
                        </p>
                  ...
                  {showReferralInfo && (
                    <div className="chart-overlay">
                      <div className="chart-card">
                        ...
                        <ul style={{ paddingLeft: 20 }}>
                          <li>
                            Every invited friend receives <strong>1 USDC + 10,000 CST</strong> as a welcome bonus.
                          </li>
                  ...
                  <section className="page-section" style={{ position: "relative", overflow: "hidden" }}>
                    ...
                    <h2 className="section-title">
                      Get a head start: 1 USDC + 10,000 CST free on registration!
                    </h2>
